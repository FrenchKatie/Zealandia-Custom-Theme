...
function custom_theme_customizer($wp_customize){
   ...
   $wp_customize->add_section('home_header_image_title_section', array(
    ...
    // for ($i=1; $i <= 1 ; $i++) {
        $wp_customize->add_section('home_page_header_image_button_link_section', array(
           'title' => __('Button Link ' , 'zealandiaTheme'),
           'priority' => 21,
           'panel' => 'Home_Page_Panel'
       ));
        ...
        $wp_customize->add_control(
           new WP_Customize_Control(
               ...
               array(
                   ...
                   'section' => 'home_page_header_image_button_link_section',
