<?php
    ...
    function add_confirm_education(){
        $realSite = 'Zealandia';
        $realSiteURL = 'https://www.visitzealandia.com/Home/gclid/CjwKCAiArK_fBRABEiwA0gOOc7sJDbi83DFdoeXUi6eJhsow5i7tlPHGs14QK9jTalrWZdKc04Fh2xoCnjkQAvD_BwE';
        $designerName = 'Katie French';
        if( ! is_admin() ){
